...
import java.sql.*;
public class RenewBookView extends JFrame{
    private JPanel contentPane;
    private JTextField t1,t2,t3,t4,t8,t9,t10;
    private JButton searchBook,searchStudent,renew,back;
    
    public static void main(String[] args) {
	new RenewBookView().setVisible(true);
    }
    public void addButtonListener(ActionListener act){
            searchBook.addActionListener(act);
            searchStudent.addActionListener(act);
            renew.addActionListener(act);
	...
	renew.setFont(new Font("Trebuchet MS", Font.BOLD, 14));
	renew.setBorder(new LineBorder(new Color(192, 192, 192), 1, true));
	renew.setBounds(47, 377, 118, 33);
	renew.setBackground(Color.BLACK);
